...
public class Dibujador extends Panel {
    ...
    /**
     * Construye un dibujador con tamao por defecto (800 x 800).
     */
    public Dibujador() {
        super();
        inicializar(800, 800);
    ...
    /**
     * Devuelve el alto del dibujador en pxeles.
     */
    public int alto() {
    ...
    /**
     * Devuelve el ancho del dibujador en pxeles.
     */
    public int ancho() {
    ...
    /**
     * Dibuja una lnea en el dibujador entre las coordenadas dadas.
     * 
     * @param desde Punto de inicio de la lnea
     * @param hasta Punto de final de la lnea
     */
    ...
    /**
     * Fabrica un dibujador en el cual se carga la imagen dada y se muestra la misma
     * en el dibujador.
     * 
     * @param img
     */
    ...
    public void paint(Graphics g) {
        if (image != null) {
            ...
            for (int i = 0; i < desde.size(); i++) {
                g.drawLine((int) desde.get(i).getX(), (int) desde.get(i).getY(), (int) hasta.get(i).getX(),
                        (int) hasta.get(i).getY());
            }
    ...
    private void paintCirculo(Graphics g, Circulo c) {
        g.drawOval((int) c.getCentro().getX() - (int) c.getRadio(), (int) c.getCentro().getY() - (int) c.getRadio(),
                (int) c.getRadio() * 2,
                (int) c.getRadio() * 2);
    }
    ...
    // // este metodo es privado porque no queremos que lo usen, y que usen en
    // cambio la version estatica para imagenes
